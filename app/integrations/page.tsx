    ...
    <div className="atlas-site">
      ...
      <div style={{ borderTop: '1px solid var(--line)', marginTop: '72px' }}>
        <div className="wrap">
          ...
          <div className="conns">
            <div className="conn"><svg className="ic" width="24" height="24" viewBox="0 0 24 24" fill="#d99405"><path d="M12 0l3.1 3.1L8.9 9.3 5.8 6.2 12 0zm6.2 6.2L21.3 9.3 12 18.6 2.7 9.3l3.1-3.1L12 12.4l6.2-6.2zM12 15.5l3.1 3.1L12 21.7l-3.1-3.1L12 15.5z" /></svg><b>Binance</b><span>Spot + Perp Futures</span></div>
            <div className="conn"><svg className="ic" width="24" height="24" viewBox="0 0 24 24" fill="#d99405"><path d="M12 0L1 6v12l11 6 11-6V6L12 0zm0 3.2l8 4.4v8.8l-8 4.4-8-4.4V7.6l8-4.4z" /></svg><b>Bybit</b><span>Spot + Derivatives</span></div>
            <div className="conn"><svg className="ic" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#d99405"><rect x="1" y="1" width="6.6" height="6.6" /><rect x="8.7" y="8.7" width="6.6" height="6.6" /><rect x="16.4" y="16.4" width="6.6" height="6.6" /><rect x="16.4" y="1" width="6.6" height="6.6" /><rect x="1" y="16.4" width="6.6" height="6.6" /></svg><b>OKX</b><span>Spot + Perp + Options</span></div>
            <div className="conn"><svg className="ic" width="24" height="24" viewBox="0 0 24 24" fill="#d99405"><path d="M12 1c2.6 0 4.7 1.4 5.9 3.7 1.4 2.7 2 6 2 8.9 0 3.4-2.6 6.2-6 6.9l-1.1-3.3c1.9-.4 3.3-1.8 3.3-3.6 0-2.4-.5-5.1-1.6-7.2C13.8 5 12.9 4.4 12 4.4S10.2 5 9.5 6.4C8.4 8.5 7.9 11.2 7.9 13.6c0 1.8 1.4 3.2 3.3 3.6L10 20.5c-3.4-.7-6-3.5-6-6.9 0-2.9.6-6.2 2-8.9C7.3 2.4 9.4 1 12 1z" /></svg><b>Alpaca</b><span>US Equities + Crypto</span></div>
            <div className="conn"><svg className="ic" width="25" height="25" viewBox="0 0 25 25" fill="#d99405"><path d="M12.5 1l10 5.5v12L12.5 24l-10-5.5v-12L12.5 1zm0 3L5 8.1v8.8l7.5 4.1 7.5-4.1V8.1L12.5 4zm0 4.2a4.3 4.3 0 110 8.6 4.3 4.3 0 010-8.6z" /></svg><b>OANDA</b><span>Forex + CFD</span></div>
          </div>
        </div>
      </div>
