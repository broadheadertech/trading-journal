  ...
  return (
    <section className="relative py-20 sm:py-24">
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[400px] bg-emerald-500 opacity-[0.05] rounded-full blur-[140px]" />
      </div>
      ...
      <div className="relative max-w-5xl mx-auto px-4 sm:px-6">
        <motion.div
          ...
          className="relative rounded-3xl border border-teal-500/20 bg-gradient-to-br from-teal-500/5 via-emerald-500/5 to-cyan-500/5 p-10 sm:p-14 text-center overflow-hidden"
        >
          {/* Inner glow */}
          <div className="absolute -top-20 left-1/2 -translate-x-1/2 w-[400px] h-[200px] bg-teal-400 opacity-[0.08] rounded-full blur-[80px]" />
          {/* Grid backdrop */}
          ...
          <div className="relative">
            ...
            <h2 className="mt-3 text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight leading-tight">
              ...
              <span className="bg-gradient-to-r from-teal-400 to-emerald-400 bg-clip-text text-transparent">repeat the same mistake</span>
            </h2>
