...
const ALL_TABS: TabId[] = [
  ...
  'goals', 'verdicts', 'checklist', 'brain', 'whatif', 'reports', 'news', 'leaderboard', 'tools', 'courses', 'events', 'community', 'coaching', 'strategies', 'rewards', 'games', 'indicators',
];

export const TIERS: Record<TierName, TierConfig> = {
  free: {
    tabs: ['dashboard', 'journal', 'playbook', 'analytics', 'psychology', 'courses', 'events', 'community', 'coaching', 'strategies', 'rewards', 'games', 'indicators'],
    maxTrades: 50,
    maxStrategies: 3,
    hasTeam: false,
    label: 'Free',
  ...
  essential: {
    tabs: ['dashboard', 'journal', 'playbook', 'analytics', 'psychology', 'goals', 'verdicts', 'checklist', 'brain', 'courses', 'events', 'community', 'coaching', 'strategies', 'rewards', 'games', 'indicators'],
    maxTrades: 200,
    maxStrategies: 10,
    hasTeam: false,
    label: 'Essential',
