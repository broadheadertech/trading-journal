...
const ITEMS = [
  { icon: Sparkles,    accent: 'from-teal-400 to-cyan-400',     title: 'Features',         desc: 'Leak detection, behavior scoring, playbook rules, 50+ metrics.', href: '/#features' },
  { icon: Workflow,    accent: 'from-emerald-400 to-lime-400',  title: 'How It Works',     desc: 'Three steps from CSV upload to measurable improvement.',         href: '/#how-it-works' },
  ...
  { icon: Plug,        accent: 'from-cyan-400 to-blue-400',     title: 'Integrations',     desc: '67+ broker CSV formats and 5 live API connectors.',              href: '/integrations' },
  ...
  return (
    <section id="explore" className="relative py-20 sm:py-24 border-t border-[var(--border)]">
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/2 right-1/4 w-[500px] h-[400px] bg-cyan-500 opacity-[0.04] rounded-full blur-[140px]" />
      </div>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6">
        ...
        >
          ...
          <h2 className="mt-3 text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight">
            Explore <span className="bg-gradient-to-r from-teal-400 to-emerald-400 bg-clip-text text-transparent">Tradia</span>
          </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
          {ITEMS.map((it, i) => (
            ...
            >
              <Link
                href={it.href}
                className="group relative block rounded-2xl border border-[var(--border)] bg-[var(--card)] p-5 hover:border-teal-500/30 transition-all overflow-hidden h-full"
              >
                ...
                <div className="relative flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between gap-2 mb-1">
                      ...
                      <ArrowUpRight size={14} className="text-[var(--muted-foreground)] group-hover:text-teal-400 group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-all" />
                    </div>
