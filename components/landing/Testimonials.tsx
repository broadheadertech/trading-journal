...
const testimonials: Testimonial[] = [
  { quote: 'Atlas helped me see that my forex losses were emotion-driven. The discipline scoring changed my game completely.', author: 'Alex M.', role: 'Forex Swing Trader', initials: 'AM' },
  ...
  { quote: 'Revenge trades after a loss cost me $8K in Q1. Atlas flagged the pattern in week one and I haven’t repeated it since.', author: 'Priya N.', role: 'FX / Gold Scalper', initials: 'PN' },
  ...
  { quote: 'I always knew FOMO entries were my biggest problem. Atlas put a price on it: $4,200 over six months. Now I think twice.', author: 'Tomás G.', role: 'Crypto Swing Trader', initials: 'TG' },
  ...
  { quote: 'Stop-loss adherence was my weakest metric. Atlas surfaced it on day one. Now my stop hit rate is 94% — used to be 60%.', author: 'Lin Y.', role: 'Crypto Day Trader', initials: 'LY' },
  ...
  { quote: 'I exported eight years of trades from MT5. The patterns Atlas found in week one would have taken me three months manually.', author: 'Yuki S.', role: 'Forex Long-term', initials: 'YS' },
  ...
  { quote: 'Trading books told me to "be calm". Atlas told me my Tuesday trades after losing Mondays lose 71% of the time. Actionable.', author: 'Marta R.', role: 'Equities Swing', initials: 'MR' },
  ...
  { quote: 'Joined Atlas for the leak detection. Stayed for the playbook engine. Both are best-in-class.', author: 'Aaron D.', role: 'Forex Algorithmic', initials: 'AD' },
  ...
  { quote: 'The mobile sync from MT5 is brilliant. Trade closes, two minutes later it’s reviewed and tagged in Atlas. Zero data entry.', author: 'Vivek S.', role: 'Indian Forex', initials: 'VS' },
  ...
  { quote: 'Atlas’s R-multiple math is correct. Most journals get this wrong. The R chart per setup type told me which strategy actually works.', author: 'Dimitri P.', role: 'Russian / EU Forex', initials: 'DP' },
  { quote: 'I’m profitable on paper. Atlas showed me 80% of my P&L came from 11% of setup types. I cut everything else.', author: 'Bonnie L.', role: 'Equity Swing', initials: 'BL' },
  { quote: 'Six months in and I’ve doubled my win rate. Not by trading better — by NOT taking the trades Atlas flagged as low-edge.', author: 'Yusuf D.', role: 'Forex / Commodities', initials: 'YD' },
  ...
  { quote: 'Migrated from TraderSync. Atlas’s leak detection is leagues ahead. The integration was easier than I expected.', author: 'Devon H.', role: 'Options Trader', initials: 'DH' },
  ...
  { quote: 'Atlas’s emotion tagging caught a pattern: I’m 3x more likely to revenge-trade after a loss above $400. $400 is now my hard stop.', author: 'Femi L.', role: 'Forex Scalper', initials: 'FL' },
  ...
  { quote: 'Atlas’s neuro-score chart over time is humbling. You see exactly when discipline slipped. Hard to lie to yourself.', author: 'Nadia B.', role: 'Crypto Day', initials: 'NB' },
  ...
  { quote: 'Atlas exposed the lie I was telling myself — that I was a swing trader. I was actually a 4-hour scalper. Repositioned my whole approach.', author: 'Cy W.', role: 'Stocks / Crypto', initials: 'CW' },
  { quote: 'The UI is gorgeous but the substance is what made me subscribe. Numbers don’t lie and Atlas’s numbers are correct.', author: 'Anika P.', role: 'Forex / Indices', initials: 'AP' },
  ...
  { quote: 'Best six months of my trading career. Atlas is the single thing that changed.', author: 'Trent K.', role: 'Funded Futures', initials: 'TK' },
  ...
  { quote: 'Sat down to "check Atlas for 10 minutes" on a Sunday. Three hours later I had a completely new playbook for Q2.', author: 'Hanan A.', role: 'Forex / Metals', initials: 'HA' },
  { quote: 'My partner asked me to show her what I do. Atlas made it explainable. She saw real progress for the first time.', author: 'Khalid I.', role: 'FX Long-term', initials: 'KI' },
  ...
  { quote: 'I’ve subscribed to four trading platforms over five years. Atlas is the only one I still log into every single day.', author: 'Lukas E.', role: 'Polish Forex', initials: 'LE' },
  { quote: 'Atlas caught an "oversized after coffee" joke pattern. I logged caffeine for two weeks — it was real. I cap espresso at one before the open.', author: 'Aurelio M.', role: 'Italian Equities', initials: 'AM' },
  ...
  { quote: 'Most journals tell you what happened. Atlas tells you what’s recurring. Different category of tool entirely.', author: 'Beatrice O.', role: 'African Forex', initials: 'BO' },
];
      ...
      <div className="relative max-w-3xl mx-auto px-4 sm:px-6">
        ...
        >
          ...
          <p className="mt-4 text-[var(--muted-foreground)]">
            See what crypto, stock, forex, futures, options, and metals traders find inside Atlas.
          </p>
        </motion.div>
