...
export const add = mutation({
  args: {
    ...
    timeframeAnalysis: v.optional(v.string()),
    timeframeEntry: v.optional(v.string()),
    bias: v.optional(v.union(v.literal("bullish"), v.literal("bearish"), v.literal("neutral"))),
    takeProfit: v.optional(v.union(v.null(), v.number())),
    lotSize: v.optional(v.union(v.null(), v.number())),
    amount: v.optional(v.union(v.null(), v.number())),
    targetPips: v.optional(v.union(v.null(), v.number())),
    pipGain: v.optional(v.union(v.null(), v.number())),
    source: v.optional(v.string()),
    totalTradesAtEntry: v.optional(v.number()),
    totalWinAmountAtEntry: v.optional(v.number()),
    createdAt: v.string(),
  },
