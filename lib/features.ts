...
const ALL_TABS: TabId[] = [
  ...
  'goals', 'verdicts', 'checklist', 'brain', 'whatif', 'reports', 'news', 'leaderboard', 'tools', 'courses', 'events', 'community', 'coaching', 'strategies', 'rewards', 'games', 'indicators', 'economic', 'world', 'articles', 'signals', 'brokers',
];
